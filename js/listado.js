...
Listado.prototype.buscarRestaurante = function(id) {
    //Utilizo la funcion find() para encontrar el id que se esta buscando,dejo guardado el valor para uso posterior
    const restaurantSeleccionado = this.restaurantes.find(restaurant => restaurant.id == id);

    if (restaurantSeleccionado !== undefined) {
...
Listado.prototype.obtenerCiudades = function() {
    ...
    let ciudades = this.restaurantes.map(function(restaurant) {
    ...
    return this.eliminaElementosRepetidos(ciudades);
}
...
Listado.prototype.obtenerRubros = function() {
    let rubros = this.restaurantes.map(function(restaurant) {
        return restaurant.rubro;
    });

    return this.eliminaElementosRepetidos(rubros);
}
...
Listado.prototype.obtenerHorarios = function() {
    ...
    let arregloHorarios = this.restaurantes.map(function(restaurant) {
    ...
    return this.eliminaElementosRepetidos(horarios);
}
